<?php
/**
 * $Id: XmapSitemap.php 158 2011-07-14 02:54:08Z guilleva $
 * $LastChangedDate: 2011-07-13 20:54:08 -0600 (Wed, 13 Jul 2011) $
...
class XmapSitemap extends JTable {
	...
	function loadItems ($view,$itemid=NULL) {
		...
		$query = "select * from #__xmap_items where view='".$db->getEscaped($view)."' and sitemap_id=".$this->id;
		$db->setQuery($query);
