...
* @version $Id: com_kunena.php 147 2010-10-27 04:52:20Z guilleva $
* @package Xmap
* @license GNU/GPL
...
class xmap_com_kunena {
	...
	*/
	...
	function getCategoryTree( &$xmap, &$parent, &$params, $parentCat ) 
	{
		...
		$list = array();
		$query = "SELECT id as cat_id, name as cat_title, ordering FROM {$params['table_prefix']}_categories WHERE parent=$parentCat AND published=1 and pub_access <=".$xmap->gid." ORDER BY name";
