<?php
/**
 * $Id: com_content.php 152 2011-01-24 04:00:32Z guilleva $
 * $LastChangedDate: 2011-01-23 22:00:32 -0600 (Sun, 23 Jan 2011) $
...
//			$params['max_art_age'] = 2;
    ...
    function showArticles(&$xmap, &$parent, $params, $query)
    {
        ...
        if (count($items) > 0) {
            ...
            foreach ($items as $item) {
                ...
                if ($params['add_pagebreaks']) {
                    $subnodes = xmap_com_content::getPagebreaks($text,$node->link,$node->uid);
    ...
    function getPagebreaks($text,$baseLink,$nodeId)
    {
