<?php
/**
 * $Id: install.xmap.php 163 2011-07-21 03:24:03Z guilleva $
 * $LastChangedDate: 2011-07-20 21:24:03 -0600 (Wed, 20 Jul 2011) $
...
if ( file_exists( $pathLangFile . $tmp_lng . '.php' )){
    ...
    <table border="0" width="90%">
	    <tr>
		    ...
		    <td width="80%"><b>Xmap 1.2.13 Stable</b></td>
	    </tr>
	    <tr>
		    ...
		    <td width="80%"><b>2011 by <a target="_blank" href="http://www.joomla.vargas.co.cr/">Guillermo Vargas</a>.</b></td>
	    </tr>
		<tr>
		...
		<tr>
			...
			echo "</tr>";
			?> </b>
			<font color="green"><b>Installation completed.</b></font><br />
			<br />
			<font color="green"><b>Xmap 1.2.13 has been installed successfully! Thank you for using Xmap! Settings can be configured in the <a href="index.php?option=com_xmap">&rarr; component menu</a>!</b></font><br /><br />
			<br /></td>
		</tr>
	    <tr>
	      <td>&nbsp;</td>
